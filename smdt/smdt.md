...
The paper doesn't specify how long the melody test plays the tone for, so I play for the entire interval duration.
...
Note, 7/18 tests were the same in the paper, however I'll be using a 50% probability of them being the same.

Further, they don't specify the individual probability of performing modifications, so I set a 40% probability to do a tone order swap,
40% probability to do a different starting point, and 20% to do both.
